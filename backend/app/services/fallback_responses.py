...
فقط أدخل رقم الشحنة (يبدأ بـ SH-) وهتحصل على كل التفاصيل! 🚚""",
...
للتفاصيل اتصل بنا: 19282 📞""",
    ...
    "coverage_area": """🗺️ نغطي جميع محافظات مصر الـ 27!
...
اتصل بنا: 19282 عشان نساعدك 💙""",

    "complaint": """😔 أنا آسفة جداً لسماع ذلك. نأخذ كل شكوى بجدية تامة!
...
هنعمل كل حاجة عشان نحل المشكلة! 💪""",
...
اتصل بنا: 19282 عشان نعمل لك عرض خاص! 📊""",
...
الدفع السهل والآمن مع شحني! 🔒""",
    ...
    "insurance_inquiry": """🛡️ تأمين الشحنات:

• تأمين مجاني حتى 2,000 ج.م
• تأمين ممتد حتى 50,000 ج.م (1% من قيمة الشحنة)
• تعويض كامل لو الشحنة ضاعت أو اتخربت بسببنا
...
قولي إزاي أقدر أساعدك! 😊""",

    "general_inquiry": """😊 أنا سارة من شحني، أقدر أساعدك في:

📦 تتبع الشحنات - أدخل رقم الشحنة
💰 أسعار الشحن - قولي المنطقة
🗺️ مناطق التغطية - بنوصل كل مكان في مصر
🔄 الإرجاع والاسترداد
🏢 حلول الشركات
...
Just enter your tracking number (starts with SH-) and you'll get all the details! 🚚""",
...
For details, call us: 19282 📞""",
    ...
    "coverage_area": """🗺️ We cover all 27 Egyptian governorates!
...
Call us: 19282 and we'll help you! 💙""",

    "complaint": """😔 I'm very sorry to hear that. We take every complaint seriously!
...
• Monthly invoices & daily reports
...
Easy and secure payments with Shiphny! 🔒""",
    ...
    "insurance_inquiry": """🛡️ Shipment Insurance:
...
Your shipment is safe with Shiphny! ✅""",
    ...
    "greeting": """Hello! 👋 I'm Sara, your smart assistant at Shiphny Express.
...
How can I help you today? 😊""",
    ...
    "general_inquiry": """😊 I'm Sara from Shiphny, I can help you with:

📦 Shipment Tracking - enter your tracking number
💰 Shipping Rates - tell me the area
🗺️ Coverage - we deliver everywhere in Egypt
🔄 Returns & Refunds
🏢 Business Solutions
